...
public class GetLegalInformationAPI {
    func getLegalInformation(os: String, version: String, currentViewController: UIViewController, completion: @escaping (String) -> Void) {
        ...
        SVProgressHUD.show(withStatus: "Searching wine database".localizedCapitalized)
            ...
            VyngleAPI.provider.request(.getLegalInformation(os, version)){ (result) in
                ...
                case let .success(response):
                    ...
                    case .success:
                        print("apiStatusCode in getLegalInformation", apiStatusCode)
                ...
                case let .failure(error):
                    print("error in getLegalInformation", error)
                    completion(status_fail)
                    break
                }
            }
